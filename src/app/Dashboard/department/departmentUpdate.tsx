...
const id=dataOfDepartment
  ...
  const mutation = useMutation({
    ...
    mutationFn: (data: departmentType,) => departmentUpdate(data, id?.id,cookies.authToken), // استخدم الدالة المعدلة
    onError: (err: any) => {
